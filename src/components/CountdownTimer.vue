...
export default {
  ...
  data () {
    return {
      currentTime: 0,
      endTime: 'March 30, 2022 17:55:00',
      t: 0,
      days: 0,
      hours: 0,
      minutes: 0,
  ...
  methods: {
    dateNow () {
      ...
      this.days = parseFloat(this.t / (1000 * 60 * 60 * 24)).toFixed(0)
      this.hours = parseFloat(((this.t / 1000) * 60 * 60) % 24).toFixed(0)
      this.minutes = parseFloat((this.t / 1000 / 60) % 60).toFixed(0)
      this.seconds = parseFloat((this.t / 1000) % 60).toFixed(0)
    }
  },
  created () {
    this.dateNow()
